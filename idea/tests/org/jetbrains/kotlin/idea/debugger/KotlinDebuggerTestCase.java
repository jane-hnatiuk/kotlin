...
public abstract class KotlinDebuggerTestCase extends DescriptorTestCase {
    ...
    private static long cachedDirLastModificationDate() {
        File lastModifiedFile = JetTestUtilsKt.dirLastModificationFile(
                TINY_APP_SRC,
                file -> FilesKt.getExtension(file).equals("out")
        );
    ...
    private static boolean isLocalCacheOutdated() {
        ...
        long currentLastDate = cachedDirLastModificationDate();
    ...
    private static void overrideTempOutputDirectory() {
        try {
            ...
            if (!LOCAL_CACHE_DIR.exists()) {
                ...
                long lastModificationDate = cachedDirLastModificationDate();
